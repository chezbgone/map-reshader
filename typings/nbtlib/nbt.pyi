...
class File(Compound):
    ...
    @classmethod
    def parse(cls, fileobj: File, byteorder=...) -> Self:
        """Override :meth:`nbtlib.tag.Base.parse` for nbt files."""
        ...

    def write(self, fileobj: File, byteorder=...) -> None:
        """Override :meth:`nbtlib.tag.Base.write` for nbt files."""
        ...

    @classmethod
    def from_fileobj(cls, fileobj: File, byteorder=...) -> Self:
    ...
    @classmethod
    def load(cls, filename: str, gzipped, byteorder=...) -> Self:
    ...
    def save(self, filename: str = ..., *, gzipped=..., byteorder=...) -> None:
